      ...
      <Card className="w-[350px]">
        <ScrollArea className="h-full w-full rounded-md border">
          <CardHeader>
            ...
            <CardDescription>
              Create User with API in one-click by filling following
              information.
            </CardDescription>
          </CardHeader>
          <CardContent>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              placeholder="Enter User Notification Email"
                              {...field}
                            />
                          </FormControl>
                          <FormDescription>
                  ...
                  <div className={cn("rounded-md border p-4")}>
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                          <div className="flex flex-row justify-between space-x-16">
                            <FormLabel>Do you want to disable user?</FormLabel>
                            <FormControl>
                              <Checkbox
                                checked={field.value}
                        ...
                        <FormItem className="flex flex-row justify-between space-y-0">
                          ...
                          <FormControl>
                            <RadioGroup
                              onValueChange={field.onChange}
                              defaultValue={field.value}
                              className="flex flex-row justify-between space-x-0 space-y-0"
                            >
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row justify-between space-y-0">
                          <FormLabel>
                            Is User <br></br> Locked?
                          </FormLabel>
                          <FormControl>
                            <RadioGroup
                              onValueChange={field.onChange}
                              defaultValue={field.value}
                              className="flex flex-row  justify-center space-x-0 space-y-0"
                            >
                              <FormItem className="flex items-center space-x-2 space-y-0">
                                <FormControl>
                                  <RadioGroupItem value="yes" />
                ...
                <div className="flex gap-2">
                  ...
                  {formStep === 0 && (
                    <Button
                      ...
                      onClick={() => {
                        // validation
                        form.trigger(["operation"]);
                        const operationState = form.getFieldState("operation");

                        if (!operationState.isDirty || operationState.invalid)
                          return;
                        setFormStep(1);
                      }}
                    >
                  ...
                  {formStep === 2 && (
                    <Button
                      ...
                      onClick={() => {
                        ...
                        const userIdState = form.getFieldState("userId");
                        const passwordState = form.getFieldState("password");
                        const emailState = form.getFieldState("email");
                        const notificationEmailState =
                          form.getFieldState("notificationEmail");

                        if (!userIdState.isDirty || userIdState.invalid) return;
                        if (!passwordState.isDirty || passwordState.invalid)
                          return;
                        if (!emailState.isDirty || emailState.invalid) return;
                        if (
                          !notificationEmailState.isDirty ||
                          notificationEmailState.invalid
                        )
                          return;
                        setFormStep(3);
                      }}
